...
// I replaced the arrow function with a regular function.Because "this" in an arrow function refers to the windo but in regular function refers to the element that recived the event. 
// I also added "," between rgb Numbers and fixed its syntax.